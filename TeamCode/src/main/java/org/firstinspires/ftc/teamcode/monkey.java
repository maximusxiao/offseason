...
public class system {
	...
	public void lift(Gamepad gamepad2, DcMotorEx l_l, DcMotorExl_r) {
	...
	public void lift_arm(Servo arm_l, arm_r, int pos) {
		if (pos == 0) {
	...
	public void stilts(Servo stilt_l, stilt_r) {
		double stow_pos = 0.4;
	...
	public void pto(Servo pto_l, pto_r) {
