...
public class ColorSensorSubsystem extends Subsystem {
    ...
    public static final double common_color = SubsystemConstants.COMMON_COLOR;
    public static final double alliance_color = SubsystemConstants.ALLIANCE_COLOR;
    ...
    public void initialize() {
        color_sensor = OpModeData.INSTANCE.getHardwareMap().get(ColorSensor.class, ConfigConstants.COLOR_SENSOR_CONFIG);
    }
}