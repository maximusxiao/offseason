...
public class LiftSubsystem extends Subsystem {
    ...
    public static final String lift_motor_l_config = "motor_lift_l";
    public static final String lift_motor_r_config = "motor_lift_r";
    ...
    public void initialize() {
        lift_motor_l = new MotorEx(lift_motor_l_config).reverse();
        lift_motor_r = new MotorEx(lift_motor_r_config);
