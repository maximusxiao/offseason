...
public class SampleCommandTeleOp extends PedroOpMode {
    ...
    public static Command do_a_pullup;
    ...
    public void build_commands() {
        ...
        do_a_pullup = new SequentialGroup(
                    StiltSubsystem.INSTANCE.activate(),
                    LiftSubsystem.INSTANCE.lift_power(1),
                    new Delay(0.7),
                    LiftSubsystem.INSTANCE.lift_power(0),
