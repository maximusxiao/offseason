...
public class LiftArmSubsystem extends Subsystem {
    ...
    public void initialize() {
        lift_arm_l_servo = OpModeData.INSTANCE.getHardwareMap().get(Servo.class, ConfigConstants.LIFT_ARM_L_CONFIG);
        lift_arm_r_servo = OpModeData.INSTANCE.getHardwareMap().get(Servo.class, ConfigConstants.LIFT_ARM_R_CONFIG);
